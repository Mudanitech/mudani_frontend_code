  ...
  const [list, setList] = useState([
    {
      ...
      description:
        'The energy sector includes companies engaged in exploration and production of oil and other hydrocarbons, refining, the transportation of oil and gas, and production of oil and gas equipment.',
        prediction : true,
    },
    {
      companyName: 'Amazon',
      ...
      companyImage: localImages.amazon,
      description:
        'The materials sector includes companies that produce chemicals, glass, paper, forestry products, metals, packaging, construction materials and steel.',
        prediction : false,
    ...
    },
    {
      ...
      companyImage: localImages.amazon,
      description:
        'The industrials sector includes companies that manufacture aerospace and defense products, electrical equipment and construction equipment.',
        prediction : true,
    ...
    },
    {
      ...
      companyImage: localImages.amazon,
      description:
        'The health care sector includes companies that provide health care services, as well as health care equipment and technology. It includes companies at all stages of pharmaceutical and biotech research, development and production.',
        prediction : false,
    ...
    },
    {
      ...
      companyImage: localImages.amazon,
      description:
        'The financials sector consists of companies involved in banking, including mortgage and consumer finance, as well as investment banks, brokerage firms and insurance companies.',
        prediction : false,
    ...
    },
    {
      ...
      companyImage: localImages.amazon,
      description:
        'The information technology sector includes companies that produce software and other IT products and services. It also contains companies that manufacture hardware such as communications equipment, mobile phones, computers and semiconductor equipment.',
        prediction : true,
    ...
    },
    {
      ...
      companyImage: localImages.amazon,
      description:
        'The communication services sector includes telecommunication and media companies, entertainment companies and those producing content and interactive games.',
      prediction: false,
    },
    {
      companyName: 'Amazon',
      ...
      companyImage: localImages.amazon,
      description:
        'The utilities sector includes companies providing electricity, gas and water (from conventional and environmentally friendly sources) as well as energy traders and distributors of energy. ',
      prediction: true,
    },
  ]);
  const modalOpen = () => {
  ...
  renderItem = ({item}) => {
    return (
      <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
        <View
          style={[
            styles.belowContainer1,
            {backgroundColor: item.prediction ? '#bcf5bc' : '#FFCCCB'},
          ]}>
          <View style={styles.belowContainer}>
            ...
            <View style={{width: wp('37%'), marginLeft: 7}}>
              <Text style={styles.companyName}>{item.companyName}</Text>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text style={styles.value1}>
                  {item.value1}
                  <Text style={styles.value2}>-{item.value2}</Text>
                </Text>
                <Image
        ...
        <View>
          {item.prediction ? (
            <Image
              source={localImages.right_green_icon}
              style={{
                height: 30,
                width: 30,
                resizeMode: 'contain',
            ...
            <Image
              source={localImages.wrong_red_icon}
              style={{
                height: 20,
                width: 20,
                resizeMode: 'contain',
          ...
          {/* <Image
            source={
              item.prediction
                ? localImages.right_green_icon
                : localImages.wrong_red_icon
            }
            style={{
              height: 30,
              width: 30,
        ...
        <View style={styles.redContainer}>
          ...
          <View style={{width: wp('75')}}>
            ...
            <Text numberOfLines={5} style={styles.inTheRedButtonSubText}>
              Pick whether the stocks below are going to close in the green (up)
              or in the red (down) for the week. We list a stock from each
      ...
      <TwoButtonModal isModalVisible={isModal} modalClose={() => modalClose()}>
        ...
        <View style={styles.popupButtonContainer}>
          <ButtonWithoutShadow
            ...
            backgroundColor={colors.black}
            onAction={() => {
              modalClose(), props.navigation.navigate('MyGameStatus');
            }}
          />
          <ButtonWithoutShadow
            width={width - wp('65%')}
