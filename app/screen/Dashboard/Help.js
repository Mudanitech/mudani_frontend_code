        ...
        <SafeAreaView>
          <ScrollView style={{flexGrow: 1}}>
            ...
            <View style={styles.mainContainer}>
              <TouchableOpacity style={styles.buttons} onPress = {()=>this.props.navigation.navigate("Messages")}>
                <View style={{width: wp('80.2%')}}>
                  <Text style={styles.buttonText}>General Inquiry</Text>
                </View>
                <Image
              ...
              <TouchableOpacity style={styles.buttons}>
                <View style={{width: wp('80.2%')}}>
                  <Text style={styles.buttonText}>Report an App Issue</Text>
                </View>
                <Image
                  source={localImages.arrowright}
                  style={{height: 11.8, width: 11.8}}
              ...
              <TouchableOpacity style={styles.buttons} onPress = {()=> this.props.navigation.navigate("FAQ")}>
                <View style={{width: wp('80.2%')}}>
