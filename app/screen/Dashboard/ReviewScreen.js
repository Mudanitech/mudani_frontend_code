      ...
      <>
        <SafeAreaView style={CustomStyles.containerbording}>
          <View style={[styles.drawerHeaderWithoutCard, {width: width}]}>
            ...
            <Image source = {localImages.cross_black} source = {{height : 120,width:120}} />
            </View> */}
            <View style={{width: wp('30%')}}>
              <Picker
                note
            ...
            <View style={styles.mainContainer}>
              ...
              <View style={styles.marketPriceContainer}>
                <View style={styles.markerSubContainer}>
                  <View style={styles.imgContainer}>
                    ...
                    <TouchableOpacity
                      onPress={() => this.modalOpen2('Market', 'Market Price')}>
                      <Image
              ...
              <View
                ...
                <ButtonWithoutShadow
                  ...
                  backgroundColor={colors.blue}
                  onAction={() =>
                    this.props.navigation.navigate('SellingDetails', {
                      symbol: symbol,
                    })
                  }
                />
