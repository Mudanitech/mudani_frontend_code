...
import {SafeAreaView, StatusBar, View, Text, Dimensions,StyleSheet,ScrollView, TouchableOpacity} from 'react-native';
          ...
          <ScrollView>
            <View style={{flex: 1, marginLeft: 40, marginRight: 30}}>
              ...
              <PlainTextInput
                  ...
                  maxLength={50}
                  iconName={this.state.showPassword ? 'visibility' : 'visibilitycross' }
                  onIconClick = {()=>this.setState({showPassword : this.state.showPassword ? false : true})}
                ...
                <PlainTextInput
                  ...
                  inputTextColor={colors.text}
                  maxLength={50}
                  iconName={this.state.showPassword ? 'visible' : 'visibilitycross' }
                  onIconClick = {()=>this.setState({showPassword : this.state.showPassword ? false : true})}
                  secureTextEntry = {this.state.showPassword}
                  onChangeText = {()=>null}
                />
              </View>
              <Text style={styles.byContinueText}>By Continuing you are agreeing to our</Text>
