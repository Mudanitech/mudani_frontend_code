...
class CustomizedPortfolioHome extends Component {
    constructor(props) {
        super()
        this.state = {
            accountType: [
    ...
    render() {
        return <>
                ...
                <HeaderWithBack backgroundColor={1} Header = {""} onActionLeft = {()=>this.props.navigation.navigate("StartYourSignUpJourney1",{id:this.props.route.params.id})}/>
                    ...
                    style={{
                      ...
                      resizeMode : "contain"
                        ...
                        <Text style={{
                            ...
                            fontWeight: "600",
                            textAlign  : "center"
                        }}>Get a customized portfolio</Text>
                        ...
                        <ButtonWithoutShadow
                            ...
                            onAction = {()=>this.props.navigation.navigate("CustomizedPortfolio")}/>
...
export default CustomizedPortfolioHome