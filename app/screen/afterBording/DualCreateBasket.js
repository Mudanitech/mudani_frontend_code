...
class DualCreateBasket extends Component {
  constructor(props) {
    super();
    this.state = {
      accountType: [
              ...
              <View style={{alignSelf: 'center', marginTop: 20}}>
                <View>
                  <TouchableOpacity style={styles.createBasketBtn1}>
                    ...
                    <Text style={styles.btnText}>Create your Basket</Text>
                ...
                <View>
                  <TouchableOpacity style={styles.createBasketBtn1}>
                    ...
                    <Text style={styles.btnText}>Link your Bank Account</Text>
                  </TouchableOpacity>
                </View>
                <View>
                  <TouchableOpacity style={styles.createBasketBtn1}>
              ...
              <View style={styles.accordianTextContainer}>
                <TouchableOpacity>
                  <Text style={{fontSize: 16, color: '#a8a8a8'}}>
                    Total time needed
                    <Text style={styles.footerText}>- 7 minutes</Text>
                  </Text>
                </TouchableOpacity>
              </View>
              <ButtonWithoutShadow
...
export default DualCreateBasket;
